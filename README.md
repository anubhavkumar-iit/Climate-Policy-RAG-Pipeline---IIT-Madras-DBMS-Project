...
(This exceeds the Track A minimum requirement of 1000 meaningful rows.)
- **Embedding model:** all-MiniLM-L6-v2 (384 dimensions, stored as TEXT)
(Vector similarity retrieval using pgvector will be integrated in Milestone 3 / Final Submission.)
...
Accept dataset terms at: https://huggingface.co/datasets/ClimatePolicyRadar/all-document-text-data
...
python injest.py
```
Expected output: 31 countries, 38 documents, 3598 chunks, 3598 embeddings.
